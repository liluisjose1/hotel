                        ...
                        <div class="row" id="page" >
                            <div class="col-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <?php
                                            ...
                                            while($reg = $ejecutar->fetch_assoc()){
                                                echo "<tr>";
                                                ?>
                                                <th scope='row'><a id='<?php echo $reg["id"]; ?>' class='id_checkin'  href=#"><?php echo $reg["id"]; ?></a></th>
                                                <?php 
                                ...
                                <div class="card-box table-responsive" >
                                    ...
                                    <br>
                                    <a  name="edit" value="Edit" id="venta_cliente" class="btn btn-success btn-sm edit_data">Procesar</a>
