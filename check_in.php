                                ...
                                <div class="card-box table-responsive">
                                    ...
                                    <table id="datatable-buttons" class="table table-striped table-bordered" cellspacing="0" width="100%">
										...
										<?php
                                            ...
                                            $sql = "SELECT * FROM habitaciones WHERE `ocupada`='1' AND estado='1'   ";
                                            ...
                                            while($reg2 = $ejecutar2->fetch_assoc()){
                                                ...
                                                echo "<td> <a href='chekin_save.php?id_h=".($reg["codigo"])."'"."class='btn btn-warning waves-effect waves-light btn-sm' id='danger-alert'><i class='ti-write'></i> Asignar    </a>
                        </td>";
                                                echo "</tr>";
                                            }
                                            ?>
